...
<div class="container" id="main-container">
    ...
    <div class="row ">
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div>
                <img src="WEB-INF/images/iconfinder_apple.png"/>
                <div>Manzanas</div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div>
                <img src="WEB-INF/images/iconfinder_strawberry.png"/>
                <div>Fresas</div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div>
                <img src="WEB-INF/images/iconfinder_orange.png"/>
                <div>Naranjas</div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div>
                <img src="WEB-INF/images/iconfinder_bread.png"/>
                <div>Pan</div>
